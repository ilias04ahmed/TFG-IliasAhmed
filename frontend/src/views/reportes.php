        ...
        <form action="/reportes" method="POST">
            ...
            <div class="mb-4">
                ...
                <textarea id="mensaje" name="mensaje" rows="4"
                    ...
                    placeholder="Describe el problema que has encontrado..." required
                    maxlength="500"
            ...
            <div class="flex justify-end">
                <button type="submit"
                    class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-6 rounded-lg shadow-md transition-colors flex items-center gap-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
                    <div class="p-5 border-b border-gray-100">
                        <div class="flex justify-between items-start mb-2">
                            <h3 class="font-semibold text-gray-800">Reporte #
                                <?php echo $reporte['id']; ?>
                            </h3>
                            <?php
                            ...
                            ?>
                            <span class="px-2.5 py-0.5 rounded-full text-xs font-bold <?php echo $badgeClass; ?>">
                                <?php echo htmlspecialchars(str_replace('_', ' ', strtoupper($reporte['estado']))); ?>
                            </span>
                        </div>
                        <p class="text-gray-600 text-sm whitespace-pre-wrap">
                            <?php echo htmlspecialchars($reporte['mensaje']); ?>
                        </p>
                        <p class="text-xs text-gray-400 mt-3 flex items-center gap-1">
                            ...
                            Enviado el
                            <?php echo htmlspecialchars($reporte['creado_en']); ?>
                        </p>
                    </div>
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-700 text-sm whitespace-pre-wrap">
                                        <?php echo htmlspecialchars($reporte['respuesta_admin']); ?>
                                    </p>
                                </div>
                            </div>
                        </div>
